...
export default function AuthModal({isSignin}: {isSignin: boolean}) {
  ...
  return (
    <div>
         ...
         <button className={`${renderContent(
      ...
      >
        <Box sx={style}>
          ...
          {error ? ( <Alert severity="error" className="mb-9">
            {error}</Alert> ) : null}
            ...
            <div className="uppercase font-bold text-center pb-2 border-b mb-2">
               ...
               <div className="m-auto">
                  ...
                  isSignin={isSignin}
                  />
                  <button className="uppercase bg-red-600 w-full text-white p-3 rounded text-sm mp-5 disabled:bg-gray-400" 
                  disabled={disabled} 
                  onClick={handleClick}
                  >
                  {renderContent("Sign In", "Create Account")}
